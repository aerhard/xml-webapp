...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../../../../../../../../../C:/Users/Lokaladmin/bin/Sencha/Cmd/5.1.2.52/plugins/src",
  ...
  "Zen": "../../app",
  "Zen.Application": "../../app/application.js"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Zen.Global": [],
  "Zen.controller.Main": [],
  "Zen.controller.component.Compilation": [],
  "Zen.controller.component.DetailPane": [],
  "Zen.controller.component.Image": [],
  "Zen.controller.component.SearchGrid": [],
  "Zen.controller.component.Versions": [],
  "Zen.controller.dialog.Dialogs": [],
  "Zen.controller.io.IO": [],
  "Zen.controller.tab.AbstractTab": [],
  "Zen.controller.tab.MainTabPanel": [],
  "Zen.model.component.DetailPane": [],
  "Zen.model.component.TreeNode": [],
  "Zen.store.component.AutoComplete": [],
  "Zen.store.component.DetailPane": [],
  "Zen.store.component.SearchFieldCombo": [],
  "Zen.store.component.SearchGrid": [],
  "Zen.store.component.Tree": [],
  "Zen.view.DoublePaneFactory": [],
  "Zen.view.Viewport": [],
  "Zen.view.component.AbstractGrid": [],
  "Zen.view.component.AbstractTree": [],
  "Zen.view.component.AutoCompleteCombo": [],
  "Zen.view.component.DetailPane": [],
  "Zen.view.component.DetailPaneContextMenu": [],
  "Zen.view.component.GlyphIconActionColumn": [],
  "Zen.view.component.Image": [],
  "Zen.view.component.PermissionsMenu": [],
  "Zen.view.component.SearchFieldCombo": [],
  "Zen.view.component.SearchFieldPane": [],
  "Zen.view.component.SearchGrid": [],
  "Zen.view.component.SearchGridContextMenu": [],
  "Zen.view.component.StatusMenu": [],
  "Zen.view.component.bin.DetailPane": [],
  "Zen.view.component.bin.SearchGrid": [],
  "Zen.view.component.compilation.CitContextMenu": [],
  "Zen.view.component.compilation.DetailPaneContextMenu": [],
  "Zen.view.component.compilation.Flipbox": [],
  "Zen.view.component.compilation.Overview": [],
  "Zen.view.component.compilation.Tree": [],
  "Zen.view.component.compilation.TreeContextMenu": [],
  "Zen.view.component.locked.DetailPane": [],
  "Zen.view.component.locked.SearchGrid": [],
  "Zen.view.component.pdf.SearchGrid": [],
  "Zen.view.component.versions.DetailPane": [],
  "Zen.view.component.versions.Versions": [],
  "Zen.view.dialog.AbstractListDialog": [],
  "Zen.view.tab.AbstractTab": [],
  "Zen.view.tab.LinkContextMenu": [],
  "Zen.view.tab.LinkTooltip": [],
  "Zen.view.tab.MainTabPanel": [],
  "Zen.view.tab.PlusTab": [],
  "Zen.view.window.MainMenu": [],
  "Zen.view.window.MessageBox": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Ext.ux.container.ButtonSegment": [
    "widget.buttonsegment"
  ],
  "Ext.ux.container.SwitchButtonSegment": [
    "widget.switchbuttonsegment"
  ],
  "Ext.ux.data.PagingMemoryProxy": [
    "proxy.pagingmemory"
  ],
  ...
  "Ext.ux.grid.menu.RangeMenu": [],
  "Ext.ux.grid.plugin.DragSelector": [
    "plugin.ux.dragselector"
  ],
  "Ext.ux.grid.plugin.MultipleSort": [
    "plugin.ux.multiplesort"
  ],
  "Ext.ux.grid.plugin.RowEditing": [
    "plugin.ux.rowediting"
  ],
  "Ext.ux.grid.plugin.SortMenu": [
    "plugin.ux.sortmenu"
  ],
  "Ext.ux.grid.property.Grid": [
    "widget.ux.propertygrid"
  ],
  "Ext.ux.grid.property.HeaderContainer": [],
  "Ext.ux.grid.property.Property": [],
  "Ext.ux.grid.property.Store": [],
  ...
  "Zen.view.component.AutoCompleteCombo": [
    "widget.autocompletecombo"
  ],
  "Zen.view.component.DetailPane": [
    "widget.detailpane"
  ],
  "Zen.view.component.DetailPaneContextMenu": [
    "widget.detailpanecontextmenu"
  ],
  "Zen.view.component.GlyphIconActionColumn": [
    "widget.glyphiconactioncolumn"
  ],
  "Zen.view.component.Image": [
    "widget.img"
  ],
  "Zen.view.component.PermissionsMenu": [
    "widget.permissionsmenu"
  ],
  "Zen.view.component.SearchFieldCombo": [
    "widget.searchfieldcombo"
  ],
  "Zen.view.component.SearchFieldPane": [
    "widget.searchfieldpane"
  ],
  "Zen.view.component.SearchGrid": [
    "widget.searchgrid"
  ],
  "Zen.view.component.SearchGridContextMenu": [
    "widget.searchgridcontextmenu"
  ],
  "Zen.view.component.StatusMenu": [
    "widget.statusmenu"
  ],
  "Zen.view.component.bin.DetailPane": [
    "widget.bin-detailpane"
  ],
  "Zen.view.component.bin.SearchGrid": [
    "widget.bin-searchgrid"
  ],
  "Zen.view.component.compilation.CitContextMenu": [
    "widget.compilation-citcontextmenu"
  ],
  "Zen.view.component.compilation.DetailPaneContextMenu": [
    "widget.compilation-detailpanecontextmenu"
  ],
  "Zen.view.component.compilation.Flipbox": [
    "widget.compilation-flipbox"
  ],
  "Zen.view.component.compilation.Overview": [
    "widget.compilation-overview"
  ],
  "Zen.view.component.compilation.Tree": [
    "widget.compilationtree"
  ],
  "Zen.view.component.compilation.TreeContextMenu": [
    "widget.compilation-treecontextmenu"
  ],
  "Zen.view.component.locked.DetailPane": [
    "widget.locked-detailpane"
  ],
  "Zen.view.component.locked.SearchGrid": [
    "widget.locked-searchgrid"
  ],
  "Zen.view.component.pdf.SearchGrid": [
    "widget.pdf-searchgrid"
  ],
  "Zen.view.component.versions.DetailPane": [
    "widget.versions-detailpane"
  ],
  "Zen.view.component.versions.Versions": [
    "widget.versions"
  ],
  "Zen.view.dialog.AbstractListDialog": [
    "widget.abstractlistdialog"
  ],
  "Zen.view.tab.AbstractTab": [
    "widget.abstracttab"
  ],
  "Zen.view.tab.LinkContextMenu": [
    "widget.linkcontextmenu"
  ],
  "Zen.view.tab.LinkTooltip": [
    "widget.linktooltip"
  ],
